...
SPEC-20260906-1122-distribuicao-release-publica | discarded | dashboard | dashboard, release, plugin, marketplace, distribuição, GitHub | Distribuir agente e plugin por um repositório público só de releases, para o comando único funcionar sem abrir o código-fonte.
...
SPEC-20260906-1932-kiro-aguardando-usuario-visivel | done | dashboard | kiro, status, waiting, painel, aprovação | A sessão do Kiro parada esperando o usuário deixa de cair em `unknown` e passa a aparecer no painel, que é onde ela precisa aparecer.
SPEC-20260906-1932-log-do-agente-observavel | done | dashboard | agente, log, diagnóstico, observabilidade | O agente instalado passa a deixar rastro em disco, para que a próxima falha de entrega seja lida em vez de adivinhada.
